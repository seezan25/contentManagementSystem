...
{
    public partial class adminUploaderEditPage : UserControl
    {
        public adminUploaderEditPage()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    connection.Open();
                    string updateQuery = "UPDATE uploaders SET Name = @NewValue1, Phone_no = @NewValue2, Address = @NewValue3,Username = @NewValue4,Password = @NewValue5 WHERE Id = @RecordID";
        ...
        private void adminUploaderEditPage_Load(object sender, EventArgs e)
        {
